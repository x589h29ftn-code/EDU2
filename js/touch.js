...
//   knoppen      schieten, springen, herladen, wapen wisselen, bukken,
//                in-/uitstappen, camera, kaart, pauze
//
...
export function initTouchControls(player, opts = {}) {
  ...
  // bukken aan en uit: hetzelfde als C op een toetsenbord
  button('tduik', () => player.bukken());
