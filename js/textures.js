...
export const HOUSE_STYLES = {
  ...
  jasker_gable:{ brick: ['#dcc89a', '#e5ddcb'], frame: '#ffffff', frame2: '#ffffff', door: ['#2a2a2a', '#1f3a6e', '#6a1a1a'], roof: '#3a3230', roofType: 'gable', storeys: 2, w: 5.6, dormer: false, chimney: true, band: '#f2f2f2' },
  wieken_white:{ brick: ['#ece9e2', '#ece9e2'], plaster: true, frame: '#ffffff', frame2: '#2b2b2b', door: ['#2b2b2b', '#1f3a6e', '#3a3a3a'], roof: '#3a3230', roofType: 'gable', storeys: 1, w: 6.0, dormer: true, chimney: false, band: '#ffffff' },
  wieken_yellow:{ brick: ['#d8c390', '#e5dccb'], frame: '#ffffff', frame2: '#ffffff', door: ['#2a2a2a', '#1f3a6e'], roof: '#3a3230', roofType: 'low', storeys: 1, w: 6.0, dormer: true, chimney: false, band: '#f2f2f2' },
  ...
  detached:   { brick: ['#7e5a48', '#c9bfae'], frame: '#ffffff', frame2: '#ffffff', door: ['#2a2a2a', '#5a2d1a'], roof: '#2f2a28', roofType: 'gable', storeys: 2, w: 10.0, dormer: false, chimney: true, band: '#f2f2f2', solar: true, detached: true },
