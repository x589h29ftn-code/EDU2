...
export const HOUSE_STYLES = {
  ...
  wieken_white:{ brick: ['#d9c9a0', '#e6dfcd'], frame: '#1746a0', frame2: '#1746a0', door: ['#1746a0', '#1746a0', '#12388a'], roof: '#3a3230', roofType: 'gable', storeys: 2, w: 5.5, dormer: true, chimney: false, band: '#f4f4f4' },
  wieken_yellow:{ brick: ['#cfbf94', '#e2dac6'], frame: '#1746a0', frame2: '#1746a0', door: ['#1746a0', '#12388a'], roof: '#38302c', roofType: 'gable', storeys: 2, w: 5.5, dormer: true, chimney: false, solar: true, band: '#f4f4f4' },
