...
for (const v of VIEWS) {
  await page.evaluate(({ at, yaw, pitch, h }) => {
...
const stats = await page.evaluate(() => ({ calls: window.__game.renderer.info.render.calls, tris: window.__game.renderer.info.render.triangles }));
